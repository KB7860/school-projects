 ...
 * Program 20.7
 * Game: Hangman
 * This program initializes a game of hangman. As the user guesses, elements
 * of the character are added. If the character loses, the hangman swings.
*/
...
public class Exercise20_7 extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Chapter20_7");
        primaryStage.show();
    }
    ...
    private class HangmanPane extends Pane {
        ...
        // List of words
        private String[] words = {"Mjolnir", "Stark", "Spider", "Starlord", 
            "Thanos"};
